// TODO - Create unit tests instead
var git = require('../')

/** Sync **/
console.log('-- Synchronous Tests --');

console.log('short', git.short([], { sync: true }));
// => aefdd94

console.log('long', git.long([], { sync: true }));
// => aefdd946ea65c88f8aa003e46474d57ed5b291d1

console.log('branch', git.branch([], { sync: true }));
// => master

console.log('tag', git.tag([], { sync: true }));
// => 0.1.0

console.log('log', git.log([], { sync: true }));
// [ [ 'aefdd946ea65c88f8aa003e46474d57ed5b291d1',
//     'add description',
//     '7 hours ago',
//     'Thomas Blobaum' ],
